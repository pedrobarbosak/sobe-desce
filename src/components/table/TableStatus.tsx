...
type Props = {
  ...
  kind: "vote" | "trump" | "discard" | "pass" | "market" | "dummy" | "raid" | "tricks" | "trickWon" | null;
  isMe: boolean;
  ...
  const what =
    kind === "trickWon"
      ...
      : isMe
        ? t("table.yourTurnNow")
        : kind === "vote"
          ? t("table.voting", { name: actor.name })
          : kind === "trump"
          ...
          : kind === "discard"
            ...
            : kind === "pass"
              ...
              : kind === "market"
                ? t("table.taking", { name: actor.name })
                : kind === "dummy"
                  ? t("table.swapping", { name: actor.name })
                  : kind === "raid"
